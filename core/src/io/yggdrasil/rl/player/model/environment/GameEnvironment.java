package io.yggdrasil.rl.player.model.environment;
...
import io.yggdrasil.rl.player.model.state.CurrentAction;
...
public class GameEnvironment {
    ...
    public List<AbstractEntity> getEnemies() {
        ...
        for (EnemyView enemy : screen.enemies)
    ...
    public List<AbstractEntity> getAllies() {
        ...
        for (PlayerView ally : screen.players)
    ...
    public ActionResult doAction(int action) throws InterruptedException {
        synchronized (getCurrentAction()) {
            ...
            skill.useCard();
         //   GameAgent.getLogger().info("Wait for action completed...");
