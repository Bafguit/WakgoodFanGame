...
public final class DataExportManager {
    ...
    public void exportAllDataTo(File parentFile) {
        if (registeredExporters == null) throw new RuntimeException("No DataExporter classes are registered.");
        ...
        for (Class<? extends DataExporter<?>> registeredExporter : registeredExporters) {
            try {
                ...
                JOptionPane.showMessageDialog(
                        null,
                        "Cannot export " + registeredExporter.getName() + " something went wrong: " + ex.getMessage());
            }
        }
