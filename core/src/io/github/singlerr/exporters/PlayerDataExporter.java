...
public final class PlayerDataExporter implements DataExporter<AbstractEnemy> {
    ...
    public void export(CSVWriter writer) throws CsvRequiredFieldEmptyException, CsvDataTypeMismatchException {
        ...
        */
        StatefulBeanToCsv<EntityStatProvider.DummyEntityStat> builder = new StatefulBeanToCsvBuilder<
                        EntityStatProvider.DummyEntityStat>(writer)
        ...
        for (Class<?> cls : classes) {
            ...
            try {
                ...
                JsonValue nameMap = FileHandler.getJsonValue(FileHandler.JsonType.CHAR_JSON);
                ...
                AbstractEntity entity =
                        (AbstractEntity) cls.getDeclaredConstructor().newInstance();
