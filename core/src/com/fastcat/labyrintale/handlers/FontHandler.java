...
public final class FontHandler implements Disposable {
  ...
  public static BitmapFont generate(
      FontType type, int size, Color color, Color bColor, boolean border) {
  ...
  public static void renderColorLeft(
  ...
  public static void renderColorCenter(
      SpriteBatch sb, FontData fontData, String text, float x, float y, float bw) {
    BitmapFont font = fontData.font;
    Matcher matcher = COLOR_PATTERN.matcher(text);
    while (matcher.find()) {
  ...
  public static class FontData implements Disposable {
    ...
    public FontData(
        FontType type, int size, boolean shadow, boolean border, Color color, Color bColor) {
