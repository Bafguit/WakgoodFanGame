...
public class FileHandler implements Disposable {
  ...
  @Getter private static final HashMap<String, Sprite> bg = new HashMap<>();
  @Getter private static final HashMap<String, Sprite> ui = new HashMap<>();
  @Getter private static final HashMap<String, Sprite> vfx = new HashMap<>();
  @Getter private static final HashMap<String, FileHandle> skeleton = new HashMap<>();
  ...
  // 상태
  @Getter private static final HashMap<String, Sprite> statusImg = new HashMap<>();
  // 아이템
  @Getter private static final HashMap<String, Sprite> itemImg = new HashMap<>();
