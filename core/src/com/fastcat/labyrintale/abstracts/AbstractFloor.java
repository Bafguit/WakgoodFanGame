...
public class AbstractFloor {
    ...
    private AbstractWay generateWay(int floor, int way, AbstractWay.WayType type) {
        ...
        if (type == ENTRY) {
            if (floor == 1)
                w = new AbstractWay(new AbstractChoice(new EntryRoom(), AbstractChoice.ChoiceType.ENTRY), type);
            else if (floor == 2)
                w = new AbstractWay(new AbstractChoice(new SecondFloorRoom(), AbstractChoice.ChoiceType.ENTRY), type);
            else if (floor == 3)
                w = new AbstractWay(new AbstractChoice(new ThirdFloorRoom(), AbstractChoice.ChoiceType.ENTRY), type);
