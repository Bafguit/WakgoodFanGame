...
public class TransformEvent extends AbstractEvent implements AtEndOfTempScreen {
    ...
    public Array<EventChoice> getChoices(int page) {
        ...
        if(page == 0) {
            a.add(new SkillRewardEventChoice(data.SELECT[0], new EventCondition.True(), this));
