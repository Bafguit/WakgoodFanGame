...
public class PurifyEvent extends AbstractEvent implements GetSelectedPlayer {
  ...
  public Array<EventChoice> getChoices(int page) {
    ...
    if (page == 0) {
      a.add(new PlayerEventChoice(data.SELECT[0], this, true));
