        ...
        if (page == 0) {
            a.add(new NextPageEventChoice(data.SELECT[0], this, 1, new EventCondition() {
                ...
                public boolean condition() {
                    return AbstractLabyrinth.advisor.id.equals("hiki")
                            || AbstractLabyrinth.advisor.id.equals("callycarly");
                }
            ...
            a.add(new BattleEventChoice(data.SELECT[4], AbstractLabyrinth.currentFloor.currentWay.enemies));
        } else {
