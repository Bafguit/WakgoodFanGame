            ...
            a.add(new ItemRewardEventChoice(
                    ...
                    new EventCondition() {
                        ...
                        public boolean condition() {
                            return AbstractLabyrinth.advisor.id.equals("dopa")
                                    || AbstractLabyrinth.advisor.id.equals("haku");
                        }
                    ...
                    1));
            a.add(new ItemRewardEventChoice(
                    data.SELECT[2], AbstractItem.ItemRarity.GOLD, new EventCondition.True(), this, 1));
