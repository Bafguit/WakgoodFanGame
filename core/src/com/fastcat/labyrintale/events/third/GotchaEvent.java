...
public class GotchaEvent extends AbstractEvent {
  ...
  public Array<EventChoice> getChoices(int page) {
    ...
    if (page == 0) {
      ...
      a.add(new ItemRewardEventChoice(data.SELECT[4], AbstractItem.ItemRarity.GOLD, new EventCondition.True(), this, 3));
    } else if (page == 2) {
      a.add(new ItemRewardEventChoice(data.SELECT[4], AbstractItem.ItemRarity.BRONZE, new EventCondition.True(), this, 3));
    } else {
