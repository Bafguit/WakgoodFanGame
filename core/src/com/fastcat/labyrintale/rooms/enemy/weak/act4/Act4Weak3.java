...
import com.fastcat.labyrintale.enemies.act4.Enemy4Weak6;
...
public class Act4Weak3 extends AbstractRoom {
    ...
    public AbstractEnemy[] getEnemies() {
        return new AbstractEnemy[] {new Enemy4Weak6(), new Enemy4Weak4(), new EnemyPlaceholder(), new EnemyPlaceholder()
        };
    }
}
