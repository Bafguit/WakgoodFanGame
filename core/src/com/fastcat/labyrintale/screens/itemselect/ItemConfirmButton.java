...
public class ItemConfirmButton extends AbstractUI {

    private final ItemSelectScreen sc;

    public ItemConfirmButton(ItemSelectScreen sc) {
    ...
    protected void onClick() {
        if(sc.selected != null) {
            sc.itemSelected(sc.selected.item);
